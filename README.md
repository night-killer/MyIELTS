...
在下从小学到大学英语基础普通，目标6.5（6.5分完全足够覆盖除英美个别学校以外几乎所有学校的本科/研究生英语要求，且对于我们理工专业来说6.0其实已经可以覆盖很大一部分了。分不在高，够用就行，不要被别人贩卖的焦虑和炒作雅思很难的机构影响）这里的计划和资料私以为可以做到备考0成本（除考试费外）的同时无痛达标（以我为例，在准备考研数一的同时准备这个，一般一天不会超过3h），或许能帮助到许多同学，至少可以帮大家节省些收集资料的时间。
...
备考IELTS前的应试英语基础：工科双非 高考120 四级560 六级480 考研56（25英1） 宁波中考口语21/25（微微高于平均）

**IELTS投入时间：3.3-4.22(7周) 每日0.5h-4h 总共约100h**  👈  建议周末好好休息或者每周工作日选几天0小时
...
| 2025-04-14 | 7.5   |    7.0  |   6.5(7.0,6.0)   |       |           | Cambridge IELTS 17 Academic Test 2 听力答案格式案例：5.30 pm 日期可以是 25 November 想要写2020年11月25日，可写成：25.11.2020 数字中间要加, 321,000 大小写不敏感  作文注意**动词、冠词、复数**|
...
| 2025-04-19 |  7.0   |   7.5  |  7.0(6.5,7.0)   |        |           | Cambridge IELTS 16 Academic Test 2 并列依次出现的阅读填词题未必在文中也是并列依次出现|
...
| 2025-04-22 |    7.0  |   |     |       |           | Cambridge IELTS 15 Academic Test 2 听力本来就没听懂的词后来也没想明白是啥意思就别随便换，反正都差不多是错的第一感觉反而容易对|
| **2025-04-26**| **6.0**       | **7.0**     |  **6.0**    | **6.5**      | **6.5**          | Real Test 大阪梅田堂岛BC雅思考点 周六考完22小时后就出分 分数刚刚好，不多不少高性价比完美6.5✌️ 刚刚好没有多浪费考研备考期间的时间精力 口语菲律宾小姐姐给分超级高（我卡了好多次，part2问的difficult thing串题准备到了，但是我就说了一半就到时间了，part3问关于teamwork和individual，属于是中文我都没啥可说的，说了一堆废话）🆘不幸的是听力抽到难的了，其中一个part做出了六级的懵逼感，🤔阅读中规中矩，😂写作不难但是只剩3min检查语法，估计存在拼写语法错误，主要是在饼图小作文用了25min，大作文（sport is business）论据论点不太好想花了点额外的时间|
...
`🧐看几遍` 口语题库（需要自己找考试日期对应的题库哦） [雅思口语2025年1-4月雅思口语题库.pdf](雅思口语2025年1-4月雅思口语题库.pdf) 👈 这里有我的串题笔记对应的话题的标记，有兴趣可以参考我的Speaking笔记本（包含串题资料，注意不要尝试去背哈，发现是在背东西会被打低分且影响流利自然，虽然中考口语确实是让背材料，不过雅思并不提倡背题，这只是为了到时候脑子里可以蹦出来话题和语料，不同串题内容完全可以结合） [Notion page](https://mica-watcher-de3.notion.site/IELTS-Speaking-1b08aba68f0380369883dcb355ed5131?pvs=74)

# 📕笔记汇总

## Reading

1. **平行阅读法**：通读全文，同时处理顺序题和乱序题（如matching）。乱序题先记关键词，做细节题时同步匹配。  
2. **定位技巧**：  
   - 小题顺序通常与文章一致，标记题目对应原文位置。  
   - TRUE/FALSE/NOT GIVEN按顺序定位，NOT GIVEN需无信息或无法推断作者观点。  
3. **填空注意**：单复数遵循原文（所看即所得），填词时避免重复上下文。  
4. **时间管理**：  
   - 难篇预留20+分钟（建议分配：15/20/25分钟）。  
   - 控制速度，避免过快漏细节。  
5. **其他**：  
   - 论述性文章文末可能复杂，需理解深层含义。  
   - 高置信度选项选直白表述，而非个人推理。  
...
1. **审题预判**：  
   - 配对题先理解选项，注意同义替换（如"children with disability"→"deaf/blind"）。  
   - 单复数通过冠词/量词判断（"a"→单数，"many"→复数），听不清写单数。  
2. **关键词技巧**：  
   - 联想替换词（如"become more interesting"→"boring before"）。  
   - 答案可能紧邻干扰项（如二选答案贴在一起）。  
3. **答案格式**：  
   - 日期（25 November/25.11.2020）、时间（5.30 pm）、数字（321,000）、大小写不敏感。  
4. **漏题应对**：错过一空立刻跟下一题，避免连锁崩溃。  
5. **其他**：
   - 拿不准的词相信第一感觉反而更好，反正本来就肯定有不会的，不用纠结 
   - 精简highlight，掐表练习。  
   - 注意空前定性词（如"made from paper"）。  
...
3. **时间管理**：  
   - 留10分钟检查语法/拼写/标点（影响coherence）。  
4. **表达优化**：  
   - 介词精准（A is located to the south of B）。  
   - 避免啰嗦，但不确定时可多写修饰词。  
